    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('Upload required documents', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black87)),
              ...
              child: Container(
                ...
                child: _image != null
                  ...
                  children: [
                    ...
                    Text('No image selected', style: TextStyle(color: Colors.grey[600], fontSize: 16)),
                  ],
                ),
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: pickImage,
                style: ElevatedButton.styleFrom(backgroundColor: Colors.green[600], foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)), elevation: 3),
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isUploading
                    ...
                    : const Text('Upload & Proceed to Council Contact', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
