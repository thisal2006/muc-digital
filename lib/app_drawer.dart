                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.eco, size: 52, color: Color(0xFF2E7D32)),
                        ),
                        const SizedBox(height: 12),
                        const Text('MUC Digital', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                        const Text('Maharagama Urban Council', style: TextStyle(fontSize: 14, color: Colors.white70)),
                      ],
                    ),
                  ),
                ],
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    print("🚀🚀🚀 BOOKING HISTORY TAPPED - GOING TO CORRECT ROUTE");
                    Navigator.pop(context);                    // close drawer
                    Navigator.pushNamed(context, '/booking-history');   // ← THIS IS THE ONLY LINE THAT MATTERS
                  },
                ),
